        ...
        await Promise.all(
            trip.participants.map(async (participant) => {
                ...
                const message = await mail.sendMail ({
                  ...
                  <p>Você foi convidado para a viagem à <strong>${trip.destination}</strong> nas datas de <strong>${formattedStartDate}</strong> até <strong>${formattedEndDate}</strong>.</p>
                  <p></p>
